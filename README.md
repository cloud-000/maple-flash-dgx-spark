...
Phase 1 convert works (`uv run maple-run convert deepgrove/maple-preview -o checkpoints/maple-2bit`). Phase 2 packed GEMV, phase 3 packed decode, and phase 4 FlashHead are implemented. Plan: [`docs/HANDOFF.md`](docs/HANDOFF.md). Agent rules: [`AGENTS.md`](AGENTS.md). Local sources: [`docs/SOURCES.md`](docs/SOURCES.md).
