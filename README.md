...
Phase 1 convert works (`uv run maple-run convert deepgrove/maple-preview -o checkpoints/maple-2bit`). Kernels are not implemented yet. Plan: [`docs/HANDOFF.md`](docs/HANDOFF.md). Agent rules: [`AGENTS.md`](AGENTS.md). Local sources: [`docs/SOURCES.md`](docs/SOURCES.md).
